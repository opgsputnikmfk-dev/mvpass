            ...
            for u in updates:
                ...
                if chat_id:
                    ...
                    if data == "SHOW_STATS":
                        ...
                        msg = f"🟢 **СТАТУС**\n\nАптайм: {hours}ч {minutes}м\nМультитаймфрейм (1H + 4H) активен."
                        edit_msg(chat_id, message_id, msg, get_main_keyboard())
                    elif data == "SHOW_STRATEGY":
                        msg = "🧠 **СТРАТЕГИЯ:** k-NN ML + Весовые коэффициенты + Макро-фильтр 1D."
                        edit_msg(chat_id, message_id, msg, get_main_keyboard())
                    elif data == "SHOW_HELP":
                        msg = "ℹ️ **СПРАВКА:** Бот работает в автономном режиме по твоему ID."
                        edit_msg(chat_id, message_id, msg, get_main_keyboard())
                    elif "message" in u and "text" in u["message"]:
                        welcome_text = (
                            "🚀 **ТЕРМИНАЛ АКТИВЕН**\n"
                            "➖➖➖➖➖➖➖➖➖➖➖➖\n"
                            "Приватный режим включен. Сканеры 1H и 4H работают.\n\n"
